 ...
 */
@ManagedBean(name = "EvalCoordADocenteConsol")
@ViewScoped
public class EvalCoordADocenteConsolManagedBean extends BaseJSFManagedBean implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc="DECLARACION VARIABLES">
    ...
    // </editor-fold> 
    public EvalCoordADocenteConsolManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    public void verReporte(String tipo) {
        ...
        if (validar() == 0) {
            ...
            paramrep = paramrep + " &titulo=EvalCordAlDocenteConsol - " + smciclo;
    ...
    private String armarparametros() {
        if (smtipfiltro.equalsIgnoreCase("D")) {
            if (smfiltrodet != null && smfiltrodet.equalsIgnoreCase("A")) {
                ls_reporte = "EvalDeCoordAlDocenteConsolGen";
                paramrep = "&anio=" + smciclo;
            } else {
                ls_reporte = "EvalDeCoordAlDocenteConsolGenFec";
        ...
        if (smtipfiltro.equalsIgnoreCase("C") || smtipfiltro.equalsIgnoreCase("I")) {
            ...
            if (smtipfiltro.equalsIgnoreCase("I")) {
                if (Long.valueOf(smciclo) >= 2020) {
                    ls_reporte = "EvalDeCoordAlDocConsolInfo2020";
                } else {
                    ls_reporte = "EvalDeCoordAlDocConsolInfo";
                }
            }
            paramrep = "&anio=" + smciclo;
            if (smarea == null) {
