 ...
 */
@ManagedBean(name = "EvalEstSocioEconomicaAnual")
@ViewScoped
public class EvalEstSocioEconomicaManagedBean extends BaseJSFManagedBean implements Serializable {
    ...
    // </editor-fold> 
    public EvalEstSocioEconomicaManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    public void verReporte(String tipo) {
         if (validar() == 0) {
            li_anio = Integer.parseInt(smciclo);
            if (li_anio >= 2016){
                ls_reporte = "EvalDeEstSocioEconoAnual_2016";
            }
            else{
            ls_reporte = "EvalDeEstSocioEconoAnual";
            }
            paramrep = "&anio=" + smciclo;
            paramrep = paramrep + " &titulo=EvalEstudSocioEcono- " + smciclo;
