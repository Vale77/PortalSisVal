 ...
 */
@ManagedBean(name = "EvalEstudAlDocenteConsol")
@ViewScoped
public class EvalEstudAlDocenteConsolManagedBean extends BaseJSFManagedBean implements Serializable {
...
// <editor-fold defaultstate="collapsed" desc="DECLARACION VARIABLES">
    ...
    // </editor-fold> 
    public EvalEstudAlDocenteConsolManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    public void verReporte(String tipo) {
        if (validar() == 0) {
            ...
            paramrep = paramrep + " &titulo=EvalEstudAlDocenteConsol - " + smciclo;
    ...
    private String armarparametros() {
        if (smtipfiltro.equalsIgnoreCase("D")) {
            if (smfiltrodet != null && smfiltrodet.equalsIgnoreCase("A")) {
                ls_reporte = "EvalDeEstudAlDocenteConsolGen";
                paramrep = "&anio=" + smciclo;
            } else {
                ls_reporte = "EvalDeEstudAlDocenteConsolGenFec";
        ...
        if (smtipfiltro.equalsIgnoreCase("C") || smtipfiltro.equalsIgnoreCase("I")) {
            ...
            if (smtipfiltro.equalsIgnoreCase("I")) {
                if (Long.valueOf(smciclo) >= 2020) {
                    ls_reporte = "EvalDeEstudADocConsolInfor2020";
                } else {
                    ls_reporte = "EvalDeEstudADocConsolInfor";
                }
            }
            paramrep = "&anio=" + smciclo;
            if (smarea == null) {
