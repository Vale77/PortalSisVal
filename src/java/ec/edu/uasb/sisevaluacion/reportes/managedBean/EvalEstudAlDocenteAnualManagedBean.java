 ...
 */
@ManagedBean(name = "EvalEstADocAnual")
@ViewScoped
public class EvalEstudAlDocenteAnualManagedBean extends BaseJSFManagedBean implements Serializable {
    ...
    // </editor-fold> 
    public EvalEstudAlDocenteAnualManagedBean() {
    }
