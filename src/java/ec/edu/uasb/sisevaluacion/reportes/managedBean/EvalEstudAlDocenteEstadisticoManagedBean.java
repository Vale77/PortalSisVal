 ...
 */
@ManagedBean(name = "EvalEstudAlDocEstadistico")
@ViewScoped
public class EvalEstudAlDocenteEstadisticoManagedBean extends BaseJSFManagedBean implements Serializable {
...
// </editor-fold> 
    public EvalEstudAlDocenteEstadisticoManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    ...
    public void verReporte(String tipo) {
        ...
        if (validar() == 0) {
            ls_reporte = "EvalDeEstudAlDocenteEstadistico";
