 ...
 */
@ManagedBean(name = "EvalEstACalidadServiciosEstadistico")
@ViewScoped
public class EvalEstACalidadServiciosEstadisticoManagedBean extends BaseJSFManagedBean implements Serializable {
...
// </editor-fold> 
    public EvalEstACalidadServiciosEstadisticoManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    ...
    public void verReporte(String tipo) {
        ...
        if (validar() == 0) {
            ls_reporte = "EvalDeEstACalSerEstadistico";
