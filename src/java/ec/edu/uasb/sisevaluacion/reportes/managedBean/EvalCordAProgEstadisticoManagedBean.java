 ...
 */
@ManagedBean(name = "EvalEstudAProgEstadistico")
@ViewScoped
public class EvalCordAProgEstadisticoManagedBean extends BaseJSFManagedBean implements Serializable {    
...
// </editor-fold> 
    ...
    public EvalCordAProgEstadisticoManagedBean() {
    }
...
// <editor-fold defaultstate="collapsed" desc="VER REPORTE">  
    ...
    public void verReporte(String tipo) {        
        if (validar() == 0) {
            ls_reporte = "EvalDeCoordAlProgramaEstadistico";
