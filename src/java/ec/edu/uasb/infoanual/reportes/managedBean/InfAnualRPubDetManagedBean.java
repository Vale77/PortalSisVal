 ...
 */
@ManagedBean(name = "InfAnualrepPub")
@ViewScoped
public class InfAnualRPubDetManagedBean extends BaseJSFManagedBean implements Serializable {
     ...
     */
    public InfAnualRPubDetManagedBean() {
    }
    ...
    private String armarparametros() {
        ...
        carpetaDocumento = consultaFacade.getPathDoc();
        if (smarea == null) {
            smarea = "T";
        }
        ...
        if (!smtipo.isEmpty()) {
            ...
            paramrep = paramrep + "&codProfesor=" + scodProfesor
                    ...
                    + "&separadorPath="+separadorPath
                    +"&carpetaDocumento="+carpetaDocumento;
        }
        ls_reporte = "InfAnualpubDetalle";
        paramrep = paramrep + "&titulo= Detalle Publicaciones";
    ...
    public void ciclovalueChangeListener() {
        ...
        if (smciclo != null) {
            ...
            if (smtipo != null && smtipo.equalsIgnoreCase("D")) {
                sql.append("AND ENCRE.ANIO = ").append(smciclo).append("");
