 ...
 */
@ManagedBean(name = "InfAnualrepPertOrga")
@ViewScoped
public class InfAnualRPertOrgaManagedBean extends BaseJSFManagedBean implements Serializable {
     ...
     */
    public InfAnualRPertOrgaManagedBean() {
    }
    ...
    private String armarparametros() {
        ...
        if (!smtipo.isEmpty()) {
            ...
            ls_reporte = "InfAnualPertOrg";   
             paramrep = paramrep+ "&titulo= Detalle Pertenencia Organizaciones";
